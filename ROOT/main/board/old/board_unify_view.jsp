  ...
  <div class="view_table data_tables">
    ...
    <table>
      ...
      <tr>
        ...
        <td width="" colspan="3" >
         ...
         <div class="width100per t_right margin_top10px">
                ...
                <tr class="last_line left_bar">
                  ...
                  <td><a href="program.jbe?<%=req_unify_str%>&method=v&idx=<%=rs_prv_seqid%>&page=<%=rq_page%>"><%=rs_prv_bsubject%></a></td>
                </tr>
               ...
               <tr class="left_bar">
                  ...
                  <td><a href="program.jbe?<%=req_unify_str%>&method=v&idx=<%=rs_next_seqid%>&page=<%=rq_page%>"><%=rs_next_bsubject%></a></td>
                </tr>
		...
		<div class='button deep_blue'><a href="board.jbe?<%=req_unify_str%>&method=l&idx=&page=<%=rq_page%>">목록</a></div>
		 </div>
