                ...
                if(record_count > 0)
                {
                  ...
                  while(rs_list.next())
                  {
                    ...
                    //rs_bsubject = "<a href='javascript:fun_view(" + rs_seqid + ");' alt='" + rs_bsubject + "'>" + rs_bsubject + "</a>";
					               ...
					               rs_bsubject = "<a href='program.jbe?" + req_unify_str + "&method=v&idx=" + rs_seqid + "&page=" + rq_page + "' alt='" + rs_bsubject + "'>" + rs_bsubject + "</a>";
                ...
                <tr>
                  ...
                  <td width="60%" height="30" align="center">
                      ...
                      if(curPage > intNumOfPage)
                      {
                        ...
                        out.println("<a href='program.jbe?" + req_unify_str + "&method=l&idx=&page=1'><img src='board/images/a_ic_ppre.gif' border='0' width='20' height='13' align='absmiddle' alt='처음페이지'></a>");
                        ...
                        out.println("<a href='program.jbe?" + req_unify_str + "&method=l&idx=&page=" + (intStart - intNumOfPage) + "'><img src='board/images/a_ic_pre.gif' border='0' width='20' height='13' align='absmiddle' alt='이전페이지' /></a>");
                      }
                      else
                      {
                      ...
                      for(i = intStart; i <= intEnd; i++)
                      {
                        ...
                        else
                        {
                          //out.println("<a href='javascript:fun_jump(" + i + ");'>[" + i + "]</a>");
						                    out.println("<a href='program.jbe?" + req_unify_str + "&method=l&idx=&page=" + i + "'>[" + i + "]</a>");
                        }
                      }
                      ...
                      if(totPage > intEnd)
                      {
                        ...
                        out.println("<a href='program.jbe?" + req_unify_str + "&method=l&idx=&page=" + (intEnd + 1) + "'><img src='board/images/a_ic_next.gif' border='0' width='20' height='13' align='absmiddle' alt='다음페이지'></a>");
                        ...
                        out.println("<a href='program.jbe?" + req_unify_str + "&method=l&idx=&page=" + totPage + "'><img src='board/images/a_ic_nnext.gif' border='0' width='20' height='13' align='absmiddle' alt='마지막페이지'></a>");
                      }
                      else
                      {
