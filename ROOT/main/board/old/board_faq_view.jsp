      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <td width="100%" align="center" valign="top">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <td height="3"  align="center" valign="top"><img src="board/images/line.gif" alt=""></td>
                  <td width="84%" height="30" align="left" colspan="4">&nbsp;&nbsp;<a href="program.jbe?<%=req_unify_str%>&method=v&idx=<%=rs_prv_seqid%>&page=<%=rq_page%>"><%=rs_prv_bsubject%></a></td>
                </tr>
                ...
                <tr>
                  ...
                  <td height="3"  align="center" valign="top"><img src="board/images/line.gif" alt=""></td>
                  <td width="84%" height="30" align="left" colspan="4">&nbsp;&nbsp;<a href="program.jbe?<%=req_unify_str%>&method=v&idx=<%=rs_next_seqid%>&page=<%=rq_page%>"><%=rs_next_bsubject%></a></td>
                </tr>
        ...
        <tr>
          <td width="100%"  height="20" align="right">
              <a href="program.jbe?<%=req_unify_str%>&method=l&idx=&page=<%=rq_page%>"><img src="board/images/button_list.gif"     width="52" height="22" border="0" alt="목록"></a>
          </td>
        </tr>
